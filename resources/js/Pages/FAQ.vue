...
const faqs = [
    {
        ...
        description:
            "Custom Framing isn't what everyone expects, it can become pricey depending on the size of your item. But custom framing isn't about the money, it's about turning your piece into something amazing and giving it the love it deserves.",
        ...
        <Section>
            ...
            <template #content>
                <div class="w-full px-4">
                    We get asked numerous questions about framing everyday and these are the most
                    common and helpful ones that could answer your queries. If not, call us up or
                    come in store for a friendly chat!
                    <div class="mx-auto w-full rounded-2xl p-2">
                        <Disclosure v-slot="{ open }" v-for="faq in faqs">
                            ...
                            >
                                ...
                                <PlusIcon v-if="!open" class="h-7 w-7 text-primary-500" />
                                <MinusIcon v-if="open" class="h-7 w-7 text-primary-500" />
                            </DisclosureButton>
