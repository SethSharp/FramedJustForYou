    ...
    <PrimaryLayout>
        <Section>
            ...
            <template #content>
                ...
                <p class="my-6">
                    At Framed Just For You, you'll find a vast selection of over 1000 picture frames,
                    ensuring you have abundant options to find the ideal frame for your jigsaw puzzle.
                    Our commitment to conservation framing is evident in every aspect of our work, and
                    this dedication extends to our meticulous process for framing jigsaw puzzles.
                </p>
            </template>
        </Section>
        ...
        <Section>
            ...
            <template #content>
                ...
                damaged or messed up and make it stand out within your home. Each step of our jigsaw puzzle
                framing is completed in house using the best materials and equipment, guaranteeing it is finished
                ...
                <div class="mt-8">
                    ...
                    <div class="sm:flex my-4">
                        <div class="w-full p-6">
                            <h1 class="text-xl font-bold">Backing</h1>
                            <p>
                    ...
                    <div class="sm:flex my-4">
                        <div class="w-full p-6">
                            <h1 class="text-xl font-bold">Overlay</h1>
                            <p>
