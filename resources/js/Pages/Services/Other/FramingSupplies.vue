...
<template>
    <Head title="Framing Supplies" />

    <PrimaryLayout>
        <Section>
            <template #header> Framing Supplies</template>
            <template #content>
                <span> We offer many framing supplies for you to use in your own projects! </span>
                ...
                <h1 class="mt-5 text-xl text-gray-700">Materials</h1>
