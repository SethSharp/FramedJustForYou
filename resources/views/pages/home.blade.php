    ...
    <div class="min-h-screen">
                        ...
                        <div class="w-full sm:flex">
                            <div class="w-full sm:w-1/2 p-12 text-lg">
                                <div class="bg-gray-200 p-4 rounded-lg">
                                    ...
                                    in the most beautiful and meaningful way. <strong> With over three decades of
                                        experience </strong>,
        ...
        <div>
            <div class="sm:w-1/2 mx-auto bg-gray-50 rounded-lg p-8">
                Our team is comprised <strong> of skilled artisans </strong> who understand the value of your keepsakes,
                whether it's <strong> artwork, photographs, needlework, or memorabilia </strong>.
                We take pride in our craftsmanship and attention to detail, ensuring that each piece we frame becomes a
                work of art in itself. <strong> As an Australian-based, family-owned and operated business </strong>,
                we are deeply rooted in our community, and our commitment to quality and customer satisfaction has
                remained unwavering since day one.
            </div>
        </div>
        ...
        <x-section.wrapper>
            <div class="w-3/4 mx-auto">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6 text-center">
                    <a href="{{route('new.custom-framing')}}"
                       class="bg-white rounded-lg overflow-hidden relative hover:scale-105 transition-transform duration-300 cursor-pointer">
                        <x-image
                        ...
                        />
                        <div
                            class="absolute bg-black/30 hover:bg-black/40 transition duration-300 top-0 left-0 right-0 bottom-0 flex items-end justify-start text-white">
                ...
                <div class="sm:w-1/2 mx-4 sm:mx-auto">
                    <div class="grid sm:grid-cols-2 text-center gap-x-6 gap-y-6 py-6">
                        ...
                        <x-cards.quote user="Seth">
                            Really good work, they found the exact frame and matting that matched my graduate
                            certificate!
                        </x-cards.quote>
                    </div>
                </div>
                    ...
                    <div class="w-1/2 p-12">
                        <div class="mx-auto">
                            <img class="mx-auto rounded-lg"
                                 alt="Picture of Diane standing next to our Computerised Matcutter"
                                 src="{{asset('images/people/diane.webp')}}"/>
                        </div>
                    </div>
